...
public class Xls_Reader {
	...
	private XSSFCell cell = null;
	   public static final Logger log = LoggerHelper.getLogger(Xls_Reader.class.getName());
	...
	//	log.info("row no is "+rowNum+"column name is"+colName);
		try{
			if(rowNum <=0){
				return "";
			}
		...
		for(int i=0;i<row.getLastCellNum();i++){
			//System.out.println("cell value is"+row.getCell(i).getStringCellValue());
		...
		if(cell.getCellType()==Cell.CELL_TYPE_STRING){
			// System.out.println("cellText1"+cell.getStringCellValue());
